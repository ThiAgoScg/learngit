...
<script type="text/javascript">
	function medicinesave(){
		$.ajax({
			type : "post",
			url : '${baseurl}medicine/submitMedicine.action',
				...
				<TBODY>
					...
					<TR>
						...
						<TD class=category width="35%">
							<div>
							<input placeholder="请输入通用名" type="text" id="ypxxCustom_mc" name="ypxxCustom.mc"  />
							</div>
						...
						<TD class=category width="35%">
							<div>
							<input placeholder="请输入剂型" type="text" id="ypxxCustom_jx" name="ypxxCustom.jx"  />
							</div>
					...
					<TR>
						...
						<TD class=category width="35%">
						<div>
							<input placeholder="请输入规格" type="text" id="ypxxCustom_gg" name="ypxxCustom.gg" />
						</div>
						...
						<TD class=category width="35%">
							<div>
							<input placeholder="请输入转换系数" type="text" id="ypxxCustom_zhxs" name="ypxxCustom.zhxs"  />
							</div>
					...
					<TR>
						...
						<TD class=category width="35%">
							<div>
							<input placeholder="请输入生产企业" type="text" id="ypxxCustom_scqymc" name="ypxxCustom.scqymc"  />
							</div>
							<div id="ypxxCustom_scqymcTip" style="color: #f00"></div>
						</TD>
						 <TD height=30 width="15%" align=right >商品名称：</TD><!-- 用处：根据名称获取单位id -->
						<TD class=category width="35%">
						<div><input placeholder="请输入商品名称"  type="text" name="ypxxCustom.spmc" /></div>
					...
					<TR>
						...
						<TD class=category width="35%">
						<div>
							<input placeholder="请输入中标价格"  style="width: 90px" type="text" name="ypxxCustom.zbjg"  />
						</div>
						...
						<select name="ypxxCustom.lb" id="ypxxCustom_lb">
							...
							<option value="${list.id }">${list.info }</option>
							</c:forEach>
						</select>
						</div>
